## COMANDI DELLA BOILERPLATE 

- **SET VERSION**: nvm use 18
- **BUILD SITE**: npm run build
- **PHP SERVER**: npm run dev

## Nota: 
se non hai PHP, qui c'è la guida per installarlo: https://medium.com/@rodolfovmartins/how-to-install-php-on-mac-6795ce469802
